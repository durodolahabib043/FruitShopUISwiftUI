...
<br />
<div align="center">
  <a href="https://www.youtube.com/@MobileAppsAcademy?sub_confirmation=1">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://www.youtube.com/@MobileAppsAcademy?sub_confirmation=1"><strong>Explore</strong></a>
    <br />
    <br />
  </p>
</div>
...
A fruit shop UI, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/FruitShopUISwiftUI.git
   ```
...
[youtube-url]: https://www.youtube.com/@MobileAppsAcademy?sub_confirmation=1
